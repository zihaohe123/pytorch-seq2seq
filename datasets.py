...
def multi30k(device, batch_size, bert, train_path, dev_path, test_path):
    ...
    source = Field(
            ...
            eos_token='[SEP]',
            lower=not bert,
            tokenize=BertTokenizer.from_pretrained('bert-base-german-cased').encode if bert else str.split,
...
def iwslt2014(device, batch_size, bert, train_path, dev_path, test_path):
