...
def parameter_parser():
    ...
    parser.add_argument('--enc_emb_dim', type=int, default=256, help='encoder embedding dimension')
    parser.add_argument('--dec_emb_dim', type=int, default=256, help='decoder embedding dimension')
